    ...
    <>
      <section className="bg-bg-3">
        <div className="page-margins py-5 flex items-center">
          <h1 className="text-white text-5xl" data-aos="fade-in-right">Rules</h1>
        </div>
      </section>
      <section className="page-margins py-16 flex flex-col gap-y-6">
        <div className="grid-cols-5 grid gap-x-4">
          <Link className="hover:scale-105 duration-200" href="/guidebook">
            <div className="hover:bg-palette-2 bg-white pb-1 rounded-lg duration-200 border-t-8 border-l-8 border-r-8 border-b-8 border-b-palette-2 border-t-palette-2 border-l-palette-2 border-r-palette-2 hover:text-white duration-200 group">
        ...
        <div className="flex flex-col gap-y-4">
          <Markdown>{info.rules.content}</Markdown>
        </div>
      </section>
    </>
  );
